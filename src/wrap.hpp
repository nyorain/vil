...
DefHandleDesc(VkIndirectExecutionSetEXT, IndirectExecutionSet, indirectExecutionSets, false, true);
DefHandleDesc(VkIndirectCommandsLayoutEXT, IndirectCommandsLayout, indirectCommandsLayouts, false, true);
